...
namespace Music.EntityFramework.Migrations
{
    ...
    [Migration("20250911122043_CreateArtistRequest")]
    partial class CreateArtistRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtistSong", b =>
                {
                    b.Property<int>("_artistsId")
                        .HasColumnType("integer");

                    b.Property<int>("_songsId")
                        .HasColumnType("integer");

                    b.HasKey("_artistsId", "_songsId");
            ...
            modelBuilder.Entity("Music.Models.Data.ArtistRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ArtistSong", b =>
                {
                    b.HasOne("Music.Models.Data.Artist", null)
                        .WithMany()
                        .HasForeignKey("_artistsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Music.Models.Data.Song", null)
                        .WithMany()
                        .HasForeignKey("_songsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Music.Models.Data.ArtistRequest", b =>
                {
                    b.HasOne("Music.Models.Data.Artist", "Artist")
                        .WithOne("ArtistRequest")
                        .HasForeignKey("Music.Models.Data.ArtistRequest", "ArtistId");

                    b.HasOne("Music.Models.Data.Account", "Requester")
