...
export default function LandingPage() {
    ...
    return (        
        <div ref={bodyRef} tabIndex={1} onKeyDown={onKeyDown} className="r-0 relative flex h-full max-h-full w-full justify-end laptop:right-[33.33333%] laptop:w-[133.33333%] desktop:right-[25%] desktop:w-[125%]">
